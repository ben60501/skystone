...
@TeleOp(name = "Holonomic", group = "TeleOp tests")
public class Holonomic extends OpMode {
    ...
    public void loop() {
        ...
        if(!gamepad1.right_bumper) {
            ...
            motorFrontRight.setPower((powerFR/Math.abs(powerFR))*0.3);
            motorFrontLeft.setPower((powerFL/Math.abs(powerFR))*0.3);
            motorBackRight.setPower((powerBR/Math.abs(powerFR))*0.3);
            motorBackLeft.setPower((powerBL/Math.abs(powerFR))*0.3);
        }
